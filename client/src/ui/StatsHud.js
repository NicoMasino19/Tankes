import { MatchPhase, MatchWinCondition, STAT_KEYS, STAT_MAX_LEVEL } from "@tankes/shared";
...
export class StatsHud {
    ...
    constructor(onUpgrade, audioOptions) {
        ...
        this.element.append(this.roundPanel, this.statsPanel, this.playerPanel, this.resultOverlay, this.respawnOverlay, this.scoreboardText);
